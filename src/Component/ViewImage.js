...
const ViewImage = (props) => {
    ...
    return(
        <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal={show}>
                ...
                <div class="fixed inset-0 z-10 overflow-y-auto">
                    ...
                    <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div class="relative sm:flex sm:items-start">
                            <RxCrossCircled className="absolute text-5xl text-white hover:text-gray-300 cursor-pointer" style={{right : 0, top : 0}} onClick={() => setShow(false)}/>
                            <img src={imagePath} className="hover:scale-125 transition-all duration-500" alt="zoom my"/>
